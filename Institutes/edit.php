...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h2 class="h2">Manage Institute>>Update</h2>
</div>
<?php
extract($_POST);
...
//    }
    ...
    if (empty($error)) {
        $sql = "UPDATE institutions SET Ins_Name='$Ins_Name',Ins_Code='$Ins_Name',Ins_Email='$Ins_Email',Ins_Tel='$Ins_Tel',Title='$Title',Director='$Director' WHERE Ins_Id='$Ins_Id'";
        $conn->query($sql);
    }
}

$sql = "SELECT * FROM institutions WHERE Ins_Id='$Ins_Id'";
$result = $conn->query($sql);
...
<div class="card mt-2">
    ...
    <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
        ...
        <div class="card-body">
            ...
            $result = $conn->query($sql);
            ?>
                            <label for="UserDistrict" class="form-label">Subjects</label>
